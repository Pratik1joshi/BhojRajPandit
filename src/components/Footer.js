          ...
          <div>
            ...
            <ul className="space-y-3">
              <li className="flex items-center space-x-3 text-gray-400">
                ...
                <a href={`tel:${profile?.phone || ''}`} className="hover:text-orange-500 transition-colors">
                  {profile?.phone || '+1 (234) 567-8900'}
                </a>
              </li>
              <li className="flex items-center space-x-3 text-gray-400">
                <FaEnvelope className="text-orange-500" />
                <a href={`mailto:${profile?.email || ''}`} className="hover:text-orange-500 transition-colors">
                  {profile?.email || 'contact@panditji.com'}
                </a>
              </li>
              <li className="flex items-center space-x-3 text-gray-400">
                <FaMapMarkerAlt className="text-orange-500" />
                <span>{profile?.city && profile?.state ? `${profile.city}, ${profile.state}` : 'Your City, State'}</span>
              </li>
              {profile?.whatsapp && (
                <li className="flex items-center space-x-3 text-gray-400">
                  ...
                  <a href={`https://wa.me/${profile.whatsapp.replace(/[^0-9]/g, '')}`} target="_blank" rel="noopener noreferrer" className="hover:text-orange-500 transition-colors">
